...
class cuda_transfer_s : public texture_transfer_backend_i
{
  ...
  public:
    cuda_transfer_s(const texture_transfer_plan_s& transfer_plan, direction_e dir, bool direct_image);
    ~cuda_transfer_s() override;

    bool        submit_transfer() final;
    bool        wait_for_transfer_completion() final;
    static bool supports_direct_image(texture_s::storage_format_e storage_format);
