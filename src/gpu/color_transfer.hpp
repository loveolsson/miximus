...
[[nodiscard]] constexpr std::array<float, 2> get_white_point(color_transfer_e c) noexcept
{
    switch (c) {
...
[[nodiscard]] constexpr mat3 get_gamut_transfer_from_rec709(color_transfer_e c) noexcept
{
...
[[nodiscard]] constexpr mat3 get_gamut_transfer_to_rec709(color_transfer_e c) noexcept
{
    if (c != color_transfer_e::Rec2020) {
        return {1.0f};
    }
...
[[nodiscard]] constexpr color_conversion_s get_color_transfer_from_yuv(color_transfer_e c) noexcept
{
...
[[nodiscard]] constexpr color_conversion_s get_color_transfer_to_yuv(color_transfer_e c) noexcept
{
    auto [wr, wb] = get_white_point(c);
