...
class web_server_impl {
  ...
  typedef std::map<connection_hdl, websocket_connection,
  ...
  typedef std::array<con_set_t, static_cast<int>(message::topic_t::_count)>
      con_by_topic_t;
  typedef std::array<message::callback_t,
                     static_cast<int>(message::topic_t::_count)>
      subscription_list_t;
...
public:
  ...
  void send_message_sync(message::topic_t topic, const std::string &msg,
