...
class web_server_impl
{
    ...
    typedef std::array<con_set_t, static_cast<int>(topic_e::_count)>                        con_by_topic_t;
    typedef std::array<callback_t, static_cast<int>(topic_e::_count)>                       subscription_list_t;
